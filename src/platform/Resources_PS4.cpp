// Resources_PS4.cpp — game data location on the PS4.
//
// Ps4Paths picks the data root at boot: /data/opticraft/data if the player
// copied a data/ tree there (so assets can be updated over FTP without
// reinstalling), otherwise /app0/data from the installed package.
...
{
    // <install>/assets.pak, keyed the way `path` is spelled here ("assets/...",
