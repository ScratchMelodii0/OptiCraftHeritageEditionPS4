// RenderTerrainAPI_GLES_PS4.cpp — PS4 terrain hooks.
//
// PS4 renders terrain through the desktop display-list path (WorldRenderer
// lists replayed by RenderList), which Ps4GlesDisplayLists compiles into static
// VBOs. None of the native-terrain hooks the Wii/PS2 backends implement are
// needed, so this matches RenderTerrainAPI_GL.cpp.
